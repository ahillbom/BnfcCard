...
#ifndef __FSL_TSENS_H__
#define __FSL_TSENS_H__
...
/*!
 * @breif Configuration for Temperature sensor
 *
...
/*!
 * @breeif Configuration for tsens clibration parameters
 *
...
/*!
 * @breif Start the coversion.
 *
 * @param bas TSENS peripheral base address.
 */
